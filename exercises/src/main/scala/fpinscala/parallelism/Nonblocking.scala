...
object Nonblocking {
  ...
  object Par {
    ...
    /** EXERCISE 7.10
      *
      * Hard: Our non-blocking representation doesn’t currently handle errors at
      * all. If at any point our computation throws an exception, the run
      * implementation’s latch never counts down and the exception is simply
      * swallowed. Can you fix that?
      */
